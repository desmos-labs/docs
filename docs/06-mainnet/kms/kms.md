...
Detailed information on how to setup a KMS with Ledger Tendermint App can be found [here](docs/06-mainnet/kms/kms_ledger.md)
...
[Here](docs/06-mainnet/kms/kms_softsign.md) you can find out how to setup it (e.g in a testnet).