...
If you want to try out RocksDB (which we suggest you to do) you can take a look at our [RocksDB installation guide](04-rocksdb-installation.md) before proceeding further. 
