...
If you want to know more about how to join the currently running public testnet, please refer to the [_Join the public testnet_](docs/05-testnets/03-join-public/03-join-public.md) page.  
:::     
